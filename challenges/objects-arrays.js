...
*/
zooAnimals.forEach(function (aniName) {
  const animalNames = [];
...
const lowerCase = zooAnimals.map(function (aniName) {
  return aniName.animal_name.toLowerCase();
});
...
*/
const populationTotal = zooAnimals.reduce(function (pop, num) {
